...
export default function SearchPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <h1 className="font-display font-semibold text-2xl text-cail-dark mb-6">Search</h1>
      ...
      <div className="relative mb-8">
        ...
        <input
          ...
          autoFocus
          maxLength={200}
          className="w-full pl-12 pr-4 py-3 text-base bg-white border border-gray-200 rounded-2xl text-cail-dark placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cail-blue focus:border-transparent shadow-sm"
        />
        {loading && (
          ...
          {Object.entries(grouped).map(([projectId, group]) => (
            <div key={projectId}>
              <div className="flex items-center gap-2 mb-3">
                <h2 className="font-display font-semibold text-sm text-cail-dark">{group.name || 'Unknown Project'}</h2>
              ...
              <div className="space-y-2">
                {group.items.map((r) => (
                  <Link
                    ...
                    className="block bg-white rounded-xl border border-gray-100 p-4 hover:shadow-md hover:-translate-y-0.5 transition-all"
                  >
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-cail-dark truncate">{r.name}</p>
                        {r.summary && (
