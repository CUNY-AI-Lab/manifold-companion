    ...
    <div ref={containerRef} className={`relative ${compact ? 'w-64' : 'w-full'}`}>
      <div className="relative">
        ...
        <input
          ...
          autoFocus={compact}
          maxLength={200}
          className="w-full pl-9 pr-3 py-2 text-sm bg-white border border-gray-200 rounded-xl text-cail-dark placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cail-blue focus:border-transparent"
        />
        {loading && (
          ...
          {results.slice(0, 3).map((r) => (
            <li key={r.id}>
              ...
              >
                ...
                {r.project_name && (
                  <p className="text-xs text-gray-500 truncate">{r.project_name}</p>
                )}
                {r.summary && (
